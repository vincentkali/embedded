...
class L3G4200D(IMU):
    ...
    def __init__(self) :
        ...
        self.write_byte(L3G4200D_CTRL_REG4, 0x08)
...
try:
    ...
    CF_pitch_old = adxl345.getPitch()
    CF_roll_old = adxl345.getRoll()
    ...
    while(1):
        ...
        CF_pitch = (CF_pitch_old + gyro.getXangle())*0.98 + adxl345.getPitch()*0.02
        CF_roll = (CF_roll_old + gyro.getYangle())*0.98 + adxl345.getRoll()*0.02
        
        CF_pitch_old = CF_pitch
        CF_roll_old = CF_roll
        
        print("ACC + Gyro:")
        print("CF_Pitch = %.3f" %(CF_pitch))
        print("CF_Roll = %.3f" %(CF_roll))
